...
List<Alignment> top = [Alignment.topCenter, Alignment.topLeft, Alignment.topRight];
List<Alignment> bot = [Alignment.bottomCenter, Alignment.bottomLeft, Alignment.bottomRight];
List<Alignment> left = [Alignment.centerLeft];
List<Alignment> right = [Alignment.centerRight];
...
class ArrowPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if(top.contains(params.endArrowPosition)){
      arrPath.moveTo(p4.dx-10, p4.dy-12.5);
      arrPath.lineTo(p4.dx, p4.dy+2.5);
      arrPath.lineTo(p4.dx+10, p4.dy-12.5);
    } else if(bot.contains(params.endArrowPosition)){
      arrPath.moveTo(p4.dx-10, p4.dy+12.5);
      arrPath.lineTo(p4.dx, p4.dy-2.5);
      arrPath.lineTo(p4.dx+10, p4.dy+12.5);
    } else if(left.contains(params.endArrowPosition)){
      arrPath.moveTo(p4.dx-12.5, p4.dy-10);
      arrPath.lineTo(p4.dx+2.5, p4.dy);
      arrPath.lineTo(p4.dx-12.5, p4.dy+10);
    } else if(right.contains(params.endArrowPosition)){
      arrPath.moveTo(p4.dx+12.5, p4.dy-10);
      arrPath.lineTo(p4.dx-2.5, p4.dy);
      arrPath.lineTo(p4.dx+12.5, p4.dy+10);
    } else {
